 ...
 */
public class FamilyQueryBuilder extends AbstractQueryBuilder<FamilyQueryBuilder> {
    ...
    public FamilyQueryBuilder(String type, QueryBuilder query, ScoreMode scoreMode) {
        this(type, query, DEFAULT_MIN_CHILDREN, DEFAULT_MAX_CHILDREN, scoreMode, null);
    }

    private FamilyQueryBuilder(String type, QueryBuilder query, int minChildren, int maxChildren, ScoreMode scoreMode,
     ...
     * Read from a stream.
     */
    public FamilyQueryBuilder(StreamInput in) throws IOException {
        super(in);
        type = in.readString();
     ...
     */
    public FamilyQueryBuilder minMaxChildren(int minChildren, int maxChildren) {
        if (minChildren < 0) {
    ...
    public FamilyQueryBuilder innerHit(InnerHitBuilder innerHit) {
     ...
     */
    public FamilyQueryBuilder ignoreUnmapped(boolean ignoreUnmapped) {
    ...
    public static Optional<FamilyQueryBuilder> fromXContent(QueryParseContext parseContext) throws IOException {
        XContentParser parser = parseContext.parser();
        float boost = AbstractQueryBuilder.DEFAULT_BOOST;
        String childType = null;
        ScoreMode scoreMode = ScoreMode.None;
        int minChildren = FamilyQueryBuilder.DEFAULT_MIN_CHILDREN;
        int maxChildren = FamilyQueryBuilder.DEFAULT_MAX_CHILDREN;
        ...
        FamilyQueryBuilder hasChildQueryBuilder = new FamilyQueryBuilder(childType, iqb.get(), scoreMode);
    ...
    private Query joinFieldDoToQuery(QueryShardContext context) throws IOException {
        ...
        if (parentIdFieldMapper != null) {
            ...
            return new FamilyLateParsingQuery(parentFilter, innerQuery,childFilter, minChildren(), maxChildren(),
    ...
    private Query parentFieldDoToQuery(QueryShardContext context) throws IOException {
        ...
        return new FamilyLateParsingQuery(parentDocMapper.typeFilter(context), innerQuery,
            childDocMapper.typeFilter(context), minChildren(), maxChildren(),
     ...
     *
     * This query is exclusively used by the {@link FamilyQueryBuilder} and {@link HasParentQueryBuilder} to get access
    ...
    public static final class FamilyLateParsingQuery extends Query {

        private final Query toQuery;
        private final Query innerQuery;
        private final Query childTypeFilter;
        ...
        FamilyLateParsingQuery(Query toQuery, Query innerQuery,Query childTypeFilter, int minChildren, int maxChildren,
        ...
        public Query rewrite(IndexReader reader) throws IOException {
            ...
            if (reader instanceof DirectoryReader) {
                ...
                builder.add(new BooleanClause(JoinUtil.createJoinQuery(joinField, Queries.filtered(innerQuery, childTypeFilter),
                    new MatchAllDocsQuery(),
                    indexSearcher,
                    scoreMode,
                    ordinalMap, minChildren, maxChildren), BooleanClause.Occur.SHOULD));
                builder.add(innerQuery, BooleanClause.Occur.SHOULD);
        ...
        public boolean equals(Object o) {
            ...
            FamilyLateParsingQuery that = (FamilyLateParsingQuery) o;
    ...
    @Override
    protected boolean doEquals(FamilyQueryBuilder that) {
    ...
    protected QueryBuilder doRewrite(QueryRewriteContext queryShardContext) throws IOException {
        ...
        if (rewrittenQuery != query) {
            FamilyQueryBuilder hasChildQueryBuilder =
                new FamilyQueryBuilder(type, rewrittenQuery, minChildren, maxChildren, scoreMode, innerHitBuilder);
            hasChildQueryBuilder.ignoreUnmapped(ignoreUnmapped);
